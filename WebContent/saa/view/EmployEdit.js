...
createBasicPanel: function() {
   ...
   doInit: function() {
	   ...
	   /*this._oProfileCtrl = new sap.ui.core.HTML('EmployProfile', 
			   {content: '<textarea style="width:\"800px\";" rows="10" cols="120" id="EmployProfile_TextArea"></textarea>' } ); 
	                      
	   this._oProfileCtrl.attachAfterRendering( function() {
		   console.error("-- this", this);
		   new nicEditor().panelInstance('EmployProfile_TextArea');
	   });
	   */
